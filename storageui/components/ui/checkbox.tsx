  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        className="absolute -inset-px flex items-center justify-center rounded-lg text-primary-foreground data-indeterminate:text-foreground data-checked:bg-primary data-unchecked:hidden"
