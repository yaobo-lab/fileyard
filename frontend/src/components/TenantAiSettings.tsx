...
export function TenantAiSettings({ tenantId, tenantName, authFetch }: TenantAiSettingsProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
            ...
            <span>{t('aiFeaturesTitle')}</span>
            {tenantName && (
              <span className="ml-2 px-2.5 py-0.5 rounded-md text-xs font-medium bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 border border-primary-200 dark:border-primary-800">
                {tenantName}
              </span>
            )}
          </h2>
