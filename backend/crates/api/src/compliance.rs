...
pub type UserConsent = clovalink_entity::entities::user_consent::Model;
pub type DeletionRequest = clovalink_entity::entities::deletion_requests::Model;
pub type FileExport = clovalink_entity::entities::file_exports::Model;
