...
impl From<app_entity::entities::file_groups::Model> for FileGroup {
    fn from(v: app_entity::entities::file_groups::Model) -> Self {
        Self {
            id: v.id,
...
pub async fn create_group(
    ...
    let group: FileGroup = state
        .store
        .groups()
        .create(app_entity::repositories::NewGroup {
            tenant_id,
            department_id,
            name: name.into(),
...
pub async fn update_group(
    ...
    let group: FileGroup = state
        ...
        .update(
            tenant_id,
            group_uuid,
            app_entity::repositories::GroupPatch {
                name: input.name,
                description: input.description,
                color: input.color,
                icon: input.icon,
