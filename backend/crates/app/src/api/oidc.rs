...
use app_entity::repositories::{NewOidcProvider, OidcProviderPatch};
...
impl From<app_entity::entities::tenant_oidc_providers::Model> for OidcProvider {
    fn from(v: app_entity::entities::tenant_oidc_providers::Model) -> Self {
        Self {
            id: v.id,
...
impl From<app_entity::entities::user_oidc_identities::Model> for OidcIdentity {
    fn from(v: app_entity::entities::user_oidc_identities::Model) -> Self {
        Self {
            id: v.id,
            user_id: v.user_id,
