...
impl From<app_entity::entities::tenant_saml_providers::Model> for SamlProvider {
    fn from(v: app_entity::entities::tenant_saml_providers::Model) -> Self {
        Self {
            id: v.id,
...
impl From<app_entity::entities::user_saml_identities::Model> for SamlIdentity {
    fn from(v: app_entity::entities::user_saml_identities::Model) -> Self {
        Self {
            id: v.id,
            user_id: v.user_id,
...
pub async fn create_provider(
    ...
    let provider_model = state
        .store
        .saml()
        .create(app_entity::NewSamlProvider {
