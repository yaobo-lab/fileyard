...
use app_core::notification_service::{Notification, NotificationPreference};
...
fn notification(m: app_entity::entities::notifications::Model) -> Notification {
    Notification {
        id: m.id,
        user_id: m.user_id,
...
fn preference(
    m: app_entity::entities::notification_preferences::Model,
...
fn tenant_setting(
    m: app_entity::entities::tenant_notification_settings::Model,
...
pub async fn update_preferences(
    ...
    for pref in input.preferences {
        state
            ...
            .update_preference(
                auth.user_id,
                app_entity::repositories::PreferencePatch {
    ...
    for setting in input.settings {
        state
            ...
            .update_tenant_setting(
                tenant_id,
                target_role.clone(),
                app_entity::repositories::TenantNotificationPatch {
