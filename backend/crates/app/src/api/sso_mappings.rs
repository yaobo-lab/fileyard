...
pub type AttributeMapping = app_entity::entities::sso_attribute_mappings::Model;
...
pub async fn create_mapping(
    ...
    let mapping = state.store.sso().create_mapping(app_entity::repositories::NewSsoMapping {
...
pub async fn update_mapping(
    ...
    let patch = app_entity::repositories::SsoMappingPatch {
