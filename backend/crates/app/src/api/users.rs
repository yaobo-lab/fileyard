...
use chrono::Utc;
use crate::auth::{require_admin, require_manager, AuthUser};
use app_core::models::{CreateUserInput, SuspendUserInput, Tenant, UpdateUserInput, User};
...
pub async fn send_password_reset_email(
    ...
    let email_sent = app_core::notification_service::send_templated_email(
        &state.store,
        &tenant,
        &target_email,
        "password_reset",
