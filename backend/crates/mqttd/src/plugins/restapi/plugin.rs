...
#[inline]
pub(super) async fn get_plugins(scx: &ServerContext) -> Result<Vec<PluginInfo>> {
...
#[inline]
pub(super) async fn get_plugin(scx: &ServerContext, name: &str) -> Result<Option<PluginInfo>> {
...
#[inline]
pub(super) async fn get_plugin_config(scx: &ServerContext, name: &str) -> Result<Vec<u8>> {
